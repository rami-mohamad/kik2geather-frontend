        ...
        <div className="mt-8 rounded-3xl border border-black/10 bg-white/80 p-6 shadow-lg backdrop-blur">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:items-end">
            ...
            <div className="lg:col-span-2 lg:flex lg:justify-end">
              <button
                ...
                onClick={onBook}
                className={[
                  "mt-2 h-[70px] w-full rounded-full border-2 border-[#858585] text-xl lg:mt-0 lg:w-[220px]",
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-8">
              <div className="flex flex-wrap items-center gap-x-10 gap-y-2 text-sm text-black/80">
